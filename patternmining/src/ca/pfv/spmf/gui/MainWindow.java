...
//        comboBox.addItem("LCMMax");
        ...
        comboBox.addItem("Closed_association_rules(using_fpclose)");
        ...
        checkboxOpenOutputText.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		if (checkboxOpenOutputText.isSelected()) {
        			checkboxOpenOutputPatterViewer.setSelected(false);
                }
        	}
        });
        checkboxOpenOutputText.setSelected(true);
        checkboxOpenOutputText.setBounds(220, 332, 150, 23);
        contentPane.add(checkboxOpenOutputText);
        

        checkboxOpenOutputPatterViewer = new JCheckBox("using SPMF viewer");
        checkboxOpenOutputPatterViewer.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		if (checkboxOpenOutputPatterViewer.isSelected()) {
        			checkboxOpenOutputText.setSelected(false);
                }
        	}
        });
        checkboxOpenOutputPatterViewer.setBounds(49, 329, 164, 29);
        ...
        JLabel lblOpenOutputFile = new JLabel("Open output file: ");
        lblOpenOutputFile.setBounds(22, 310, 157, 20);
	...
	private void updateUserInterfaceAfterAlgorithmSelection(String algorithmName, boolean isSelected) {
        ...
        if (isSelected) {
            ...
            //					comboBox.addItem("Fournier08-Closed+time+valued_items");
                ...
                // show the parameters of this algorithm
                hideAllParams();
                setParam(textFieldParam1, "Choose maxsup (%):", labelParam1, "(e.g. 0.8 or 80%)");
                ...
                setParam(textFieldParam1, "Choose expected support (%):", labelParam1, "(e.g. 0.10)");
                    ...
                    || "Closed_association_rules(using_fpclose)".equals(algorithmName)
                ...
                // show the parameters of this algorithm
                hideAllParams();
                setParam(textFieldParam1, "Choose minutil:", labelParam1, "(e.g. 55)");
                setParam(textFieldParam2, "Max. pattern length (optional):", labelParam2, "(e.g. 4)");

            } else if ("FHMFreq".equals(algorithmName)) {
                // show the parameters of this algorithm
                hideAllParams();
                setParam(textFieldParam1, "Choose minutility:", labelParam1, "(e.g. 30)");
                setParam(textFieldParam2, "Choose minsup:", labelParam2, "(e.g. 0.40)");
            }else if ("FHM+".equals(algorithmName)) {
                // show the parameters of this algorithm
                hideAllParams();
                setParam(textFieldParam1, "Choose minutility:", labelParam1, "(e.g. 30)");
                setParam(textFieldParam2, "Choose minimum length:", labelParam2, "(e.g. 2 items)");
                setParam(textFieldParam3, "Choose maximum length:", labelParam3, "(e.g. 3 items)");
            } else if ("FCHM".equals(algorithmName)
            		) {
                // show the parameters of this algorithm
                hideAllParams();
                setParam(textFieldParam1, "Choose minutility:", labelParam1, "(e.g. 30)");
                setParam(textFieldParam2, "Choose minbond:", labelParam2, "(e.g. 0.50)");
...
//		.setVisible(false);
    ...
    private void openHelpWebPageForAlgorithm(String choice) {
        ...
        }else if ("Closed_association_rules(using_fpclose)".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#example20");
        }
		//IGB
        ...
        }else if ("CHUI-Miner".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#chuiminer");
        }else if ("GHUI-Miner".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#ghuiminer");
            ...
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#fhmplus");
        }
        else if ("FHMFreq".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#fhmfreq");
        }else if ("FCHM".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#fchm");
        }else if ("USpan".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#uspan");
